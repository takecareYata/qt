...
#include <memory>
#include "../camera_practice/camerathread.h"
...
QT_MOC_LITERAL(1, 7, 9), // "send_data"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12) // "const uchar*"

    },
    "Camera\0send_data\0\0const uchar*"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->send_data((*reinterpret_cast< const uchar*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Camera::*)(const uchar * , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Camera::send_data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Camera::send_data(const uchar * _t1, int _t2, int _t3)
{
