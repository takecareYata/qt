...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(10, 10, 231, 114));
        ...
        lblHobby = new QLabel(layoutWidget);
        lblHobby->setObjectName(QString::fromUtf8("lblHobby"));

        verticalLayout->addWidget(lblHobby);

        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 251, 19));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblHobby->setText(QCoreApplication::translate("MainWindow", "Hobby: unknown", nullptr));
    } // retranslateUi
